...
ISTIO_MOSN_DEBUG_URL=${ISTIO_MOSN_DEBUG_URL:-http://xxx/mosn-debug-${ISTIO_MOSN_VERSION}.tar.gz}
ISTIO_MOSN_RELEASE_URL=${ISTIO_MOSN_RELEASE_URL:-http://xxx/mosn-alpha-${ISTIO_MOSN_VERSION}.tar.gz}
